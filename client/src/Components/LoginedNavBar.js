        ...
        <Collapse isOpen={isOpen} navbar>
          <Nav style={{ marginLeft: "auto" }}>
            <NavItem className="nav-link nav-item" style={{ padding: 0 }}>
              <Link className="nav-link btn btn-dark" to="/homepage">
                HOME
              </Link>
            </NavItem>
            {userType === "mentee" && (
              <NavItem className="nav-link nav-item" style={{ padding: 0 }}>
                <Link className="nav-link btn btn-dark" to="/find-mentor">
                  FIND MENTOR
                </Link>
              </NavItem>
            )}
            <NavItem className="nav-link nav-item" style={{ padding: 0 }}>
              <Link className="nav-link btn btn-dark" to="/profile">
                PROFILE
              </Link>
            </NavItem>
            <NavItem className="nav-link nav-item" style={{ padding: 0 }}>
              <Link className="nav-link btn btn-dark" to="/settings">
                SETTINGS
              </Link>
            </NavItem>
            <NavItem className="nav-link nav-item" style={{ padding: 0 }}>
