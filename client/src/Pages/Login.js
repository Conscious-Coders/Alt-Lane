...
function Login() {
  ...
  return (
    <div>
      ...
      <div
        className="container"
        style={{ marginTop: "2%", minHeight: "60vh", marginBottom: "10%" }}
      >
        <img
          src="/alt_lane_black.png"
          style={{ width: "125px", margin: "3%", height: "auto" }}
          alt="alt-line logo"
        />
            ...
            >
              {form.errorMessage && (
                <p
                  ...
                  style={{ background: "#D6C5F9", padding: "1%" }}
                >
                  {form.errorMessage}
                </p>
              )}
              <form onSubmit={handleSubmit} style={{ marginTop: "5%" }}>
                ...
                <Button
                  ...
                  name={form.isSubmitting ? "Loading..." : "Login"}
                />
                <br />
              </form>
            </div>
