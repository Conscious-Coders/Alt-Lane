        ...
        {!data ? <DefaultHome/> : 
          <div style={{marginTop:"5%", minHeight: "50vh", marginBottom:"10%", position: "relative"}}>
            <div className="homepage">
                {authState.userType === "mentor" ? <h2 className="" style={{fontSize: "20px", color: "#764288", marginBottom: "20px"}}>Meet Your Mentee</h2> : <h2 style={{fontSize: "40px", color: "#764288", marginBottom: "20px"}}>Meet Your Mentor</h2>}
